...
do
    ...
    CMD1="python test/mezo_sgd/nanogpt/test_memory.py --model_id $model_id --zo_method zo --max_steps 100 --eval"
    CMD2="python test/mezo_sgd/nanogpt/test_memory.py --model_id $model_id --zo_method zo2 --max_steps 100 --eval"
